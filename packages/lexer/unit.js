...
describe(`indenterMatch`, () => {
  ...
  describe(`emote`, () => {
    run(`a \t\t \t iS \t \t b`, { emote: { characters: [`a`], emote: `b` } })
    run(`aBc \t\t \t iS \t \t b`, { emote: { characters: [`aBc`], emote: `b` } })
    run(`a \t\t \t iS \t \t bCD`, { emote: { characters: [`a`], emote: `bCD` } })
    run(`a \t\t \t iS \t \t b`, { emote: { characters: [`a`], emote: `b` } })
    run(`a \t\t \t and  \t \t B \t\t \t Are \t \t c`, { emote: { characters: [`a`, `B`], emote: `c` } })
    run(`aBC \t\t \t and  \t \t D \t\t \t are \t \t e`, { emote: { characters: [`aBC`, `D`], emote: `e` } })
    run(`a \t\t \t and  \t \t BcD \t\t \t are \t \t e`, { emote: { characters: [`a`, `BcD`], emote: `e` } })
    run(`a \t\t \t and  \t \t B \t\t \t ARE \t \t cDE`, { emote: { characters: [`a`, `B`], emote: `cDE` } })
    run(`a \t\t \t B \t       \t and  \t \t C \t\t \t Are \t \t d`, { emote: { characters: [`a`, `B`, `C`], emote: `d` } })
    run(`aBC \t\t \t d \t       \t and  \t \t e \t\t \t ArE \t \t f`, { emote: { characters: [`aBC`, `d`, `e`], emote: `f` } })
    run(`a \t\t \t bCd \t       \t and  \t \t e \t\t \t aRe \t \t f`, { emote: { characters: [`a`, `bCd`, `e`], emote: `f` } })
    run(`a \t\t \t B \t       \t and  \t \t cdE \t\t \t arE \t \t f`, { emote: { characters: [`a`, `B`, `cdE`], emote: `f` } })
    run(`a \t\t \t b \t       \t and  \t \t C \t\t \t ARE \t \t Def`, { emote: { characters: [`a`, `b`, `C`], emote: `Def` } })
    run(`a \t\t \t B \t       \t c\t \tand  \t \t d \t\t \t ARE \t \t E`, { emote: { characters: [`a`, `B`, `c`, `d`], emote: `E` } })
    run(`ABC \t\t \t d \t       \t e\t \tand  \t \t f \t\t \t are \t \t g`, { emote: { characters: [`ABC`, `d`, `e`, `f`], emote: `g` } })
    run(`a \t\t \t bcd \t       \t e\t \tand  \t \t f \t\t \t arE \t \t g`, { emote: { characters: [`a`, `bcd`, `e`, `f`], emote: `g` } })
    run(`a \t\t \t B \t       \t cDE\t \tand  \t \t f \t\t \t ARe \t \t g`, { emote: { characters: [`a`, `B`, `cDE`, `f`], emote: `g` } })
