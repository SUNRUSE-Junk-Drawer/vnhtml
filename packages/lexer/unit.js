...
describe(`create`, () => {
  ...
  it(`returns endOfFile, false`, () => expect(result.endOfFile).toBe(false))
  it(`returns exceptionThrown, false`, () => expect(result.exceptionThrown).toBe(false))
  it(`returns recursing, false`, () => expect(result.recursing).toBe(false))
