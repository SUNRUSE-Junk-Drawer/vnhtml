...
describe(`indenterMatch`, () => {
  ...
  describe(`line with text`, () => {
    run(`a:b`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `b` } })
    run(`a  \t \t :b`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `b` } })
    run(`a:\t\t  \t b`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `b` } })
    run(`aBC:d`, { aBC: `Test Normalized Name A` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], text: `d` } })
    run(`aBC  \t \t :d`, { aBC: `Test Normalized Name A` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], text: `d` } })
    run(`aBC:\t\t  \t d`, { aBC: `Test Normalized Name A` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], text: `d` } })
    run(`a:BCd \t \t \t\t eFGh \t : \t \t\t ijKL`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `BCd \t \t \t\t eFGh \t : \t \t\t ijKL` } })
    run(`a  \t \t :BCd \t \t \t\t eFGh \t : \t \t\t ijKL`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `BCd \t \t \t\t eFGh \t : \t \t\t ijKL` } })
    run(`a:\t\t  \t BCd \t \t \t\t eFGh \t : \t \t\t ijKL`, { a: `Test Normalized Name A` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], text: `BCd \t \t \t\t eFGh \t : \t \t\t ijKL` } })
    run(`a \t\t  \t AnD \t \t  b:c`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `c` } })
    run(`a \t\t  \t AnD \t \t  b\t   \t\t:c`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `c` } })
    run(`a \t\t  \t AnD \t \t  b: \t\t  \t c`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `c` } })
    run(`aBC \t\t  \t AnD \t \t  d:e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`aBC \t\t  \t AnD \t \t  d\t   \t\t:e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`aBC \t\t  \t AnD \t \t  d: \t\t  \t e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`a \t\t  \t AnD \t \t  BCd:e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`a \t\t  \t AnD \t \t  BCd\t   \t\t:e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`a \t\t  \t AnD \t \t  BCd: \t\t  \t e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], text: `e` } })
    run(`a \t\t  \t AnD \t \t  b:cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t\t  \t AnD \t \t  b\t   \t\t:cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t\t  \t AnD \t \t  b: \t\t  \t cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Name B` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c:d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `d` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c  \t \t :d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `d` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c:  \t \t d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `d` } })
    run(`aBC \t\t  \t d   \t\t AnD  \t \t \t e:f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`aBC \t\t  \t d   \t\t AnD  \t \t \t e  \t \t :f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`aBC \t\t  \t d   \t\t AnD  \t \t \t e:  \t \t f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t BCd   \t\t AnD  \t \t \t e:f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t BCd   \t\t AnD  \t \t \t e  \t \t :f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t BCd   \t\t AnD  \t \t \t e:  \t \t f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t cDE:f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `cDE`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t cDE  \t \t :f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `cDE`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t cDE:  \t \t f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `cDE`, normalizedName: `Test Normalized Name C` }], text: `f` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c:dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c  \t \t :dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a \t\t  \t b   \t\t AnD  \t \t \t c:  \t \t dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a \t \t \t   \t\t b \t \tc    \t AnD \t\t d:e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Name D` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }, { name: `d`, normalizedName: `Test Normalized Name D` }], text: `e` } })
    run(`a \t \t \t   \t\t b \t \tc    \t AnD \t\t d \t \t\t \t :e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Name D` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }, { name: `d`, normalizedName: `Test Normalized Name D` }], text: `e` } })
    run(`a \t \t \t   \t\t b \t \tc    \t AnD \t\t d: \t \t\t \t e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Name D` }, { line: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }, { name: `d`, normalizedName: `Test Normalized Name D` }], text: `e` } })
    run(`aBC \t \t \t   \t\t d \t \te    \t AnD \t\t f:g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Name D` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }, { name: `f`, normalizedName: `Test Normalized Name D` }], text: `g` } })
    run(`aBC \t \t \t   \t\t d \t \te    \t AnD \t\t f \t \t\t \t :g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Name D` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }, { name: `f`, normalizedName: `Test Normalized Name D` }], text: `g` } })
    run(`aBC \t \t \t   \t\t d \t \te    \t AnD \t\t f: \t \t\t \t g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Name D` }, { line: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }, { name: `f`, normalizedName: `Test Normalized Name D` }], text: `g` } })
  ...
  describe(`line with emote and text`, () => {
    run(`a(b):c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`a \t \t\t (b):c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`a( \t \t\t b):c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`a(b   \t\t \t ):c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`a(b)   \t\t \t    \t   \t :c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`a(b):   \t\t \t    \t   \t c`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `c` } })
    run(`aBC(d):e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC \t \t\t (d):e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC( \t \t\t d):e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC(d   \t\t \t ):e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC(d)   \t\t \t    \t   \t :e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC(d):   \t\t \t    \t   \t e`, { aBC: `Test Normalized Name A`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a(BCd):e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a \t \t\t (BCd):e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a( \t \t\t BCd):e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a(BCd   \t\t \t ):e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a(BCd)   \t\t \t    \t   \t :e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a(BCd):   \t\t \t    \t   \t e`, { a: `Test Normalized Name A`, BCd: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `BCd`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a \t \t\t (b):cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t \t\t (   \t\t \t b):cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t \t\t (b   \t\t \t ):cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t \t\t (b)   \t\t \t :cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a \t \t\t (b):   \t\t \t cDE \t \t \t\t FGhi \t : \t \t\t jkl`, { a: `Test Normalized Name A`, b: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }], emote: `b`, normalizedEmote: `Test Normalized Emote`, text: `cDE \t \t \t\t FGhi \t : \t \t\t jkl` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(c):d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (c):d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb( \t \t\t c):d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(c   \t\t \t ):d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(c)   \t\t \t    \t   \t :d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(c):   \t\t \t    \t   \t d`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `d` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td(e):f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td \t \t\t (e):f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td( \t \t\t e):f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td(e   \t\t \t ):f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td(e)   \t\t \t    \t   \t :f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`aBC  \t  \t \t  AnD \t \t\t \t \td(e):   \t\t \t    \t   \t f`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd(e):f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd \t \t\t (e):f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd( \t \t\t e):f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd(e   \t\t \t ):f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd(e)   \t\t \t    \t   \t :f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tBCd(e):   \t\t \t    \t   \t f`, { a: `Test Normalized Name A`, BCd: `Test Normalized Name B`, e: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `BCd`, normalizedName: `Test Normalized Name B` }], emote: `e`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(cDE):f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (cDE):f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb( \t \t\t cDE):f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(cDE   \t\t \t ):f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(cDE)   \t\t \t    \t   \t :f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb(cDE):   \t\t \t    \t   \t f`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, cDE: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `cDE`, normalizedEmote: `Test Normalized Emote`, text: `f` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (c):dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (   \t\t \t    \t   \t c):dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (c   \t\t \t    \t   \t ):dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (c)   \t\t \t    \t   \t :dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a  \t  \t \t  AnD \t \t\t \t \tb \t \t\t (c):   \t\t \t    \t   \t dEf \t \t \t\t GhiJ \t : \t \t\t klm`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }], emote: `c`, normalizedEmote: `Test Normalized Emote`, text: `dEf \t \t \t\t GhiJ \t : \t \t\t klm` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc(d):e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc \t \t\t (d):e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc( \t \t\t d):e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc(d   \t\t \t ):e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc(d)   \t\t \t    \t   \t :e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`a   \t \t \t  b  \t  \t \t  AnD \t \t\t \t \tc(d):   \t\t \t    \t   \t e`, { a: `Test Normalized Name A`, b: `Test Normalized Name B`, c: `Test Normalized Name C`, d: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `a`, normalizedName: `Test Normalized Name A` }, { name: `b`, normalizedName: `Test Normalized Name B` }, { name: `c`, normalizedName: `Test Normalized Name C` }], emote: `d`, normalizedEmote: `Test Normalized Emote`, text: `e` } })
    run(`aBC   \t \t \t  d  \t  \t \t  AnD \t \t\t \t \te(f):g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], emote: `f`, normalizedEmote: `Test Normalized Emote`, text: `g` } })
    run(`aBC   \t \t \t  d  \t  \t \t  AnD \t \t\t \t \te \t \t\t (f):g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], emote: `f`, normalizedEmote: `Test Normalized Emote`, text: `g` } })
    run(`aBC   \t \t \t  d  \t  \t \t  AnD \t \t\t \t \te( \t \t\t f):g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], emote: `f`, normalizedEmote: `Test Normalized Emote`, text: `g` } })
    run(`aBC   \t \t \t  d  \t  \t \t  AnD \t \t\t \t \te(f   \t\t \t ):g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], emote: `f`, normalizedEmote: `Test Normalized Emote`, text: `g` } })
    run(`aBC   \t \t \t  d  \t  \t \t  AnD \t \t\t \t \te(f)   \t\t \t    \t   \t :g`, { aBC: `Test Normalized Name A`, d: `Test Normalized Name B`, e: `Test Normalized Name C`, f: `Test Normalized Emote` }, { lineWithEmote: { characters: [{ name: `aBC`, normalizedName: `Test Normalized Name A` }, { name: `d`, normalizedName: `Test Normalized Name B` }, { name: `e`, normalizedName: `Test Normalized Name C` }], emote: `f`, normalizedEmote: `Test Normalized Emote`, text: `g` } })
...
describe(`text`, () => {
  ...
  describe(`when no error is thrown`, () => {
    beforeEach(() => {
      character.and.stub()
      index.text(`Test State`, `Test 💩 Text`)
    })
    ...
    it(`passes the characters of the given text to character, in order`, () => {
      ...
      expect(character.calls.argsFor(5)).toEqual([jasmine.anything(), `💩`])
