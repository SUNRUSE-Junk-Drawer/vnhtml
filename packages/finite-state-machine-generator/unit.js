...
describe(`findPromptStatesInStatementArray`, () => {
  ...
  const run = (description, statements, then) => describe(description, () => {
    beforeEach(() => {
      ...
      result = get(`findPromptStatesInStatementArray`)(`Test Context`, `Test On Error`, statementsCopy, `Test Prompt States`, `Test Labels`)
    })
  ...
  run(`one statement`, [`Test Statement A`], () => {
    ...
    it(`calls findPromptStatesInStatement with the given context`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(`Test Context`, jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given onError`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), `Test On Error`, jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the first given statement`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), `Test Statement A`, jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the next given statements`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), [], jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given prompt states`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Prompt States`, jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given labels`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Labels`))
  ...
  run(`two statements`, [`Test Statement A`, `Test Statement B`], () => {
    ...
    it(`calls findPromptStatesInStatement with the given onError`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), `Test On Error`, jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the first given statement`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), `Test Statement A`, jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the next given statements`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), [`Test Statement B`], jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given prompt states`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Prompt States`, jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given labels`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Labels`))
    it(`returns the result of findPromptStatesInStatement`, () => expect(result).toEqual(`Test Recursed States`))
  })
  run(`three statements`, [`Test Statement A`, `Test Statement B`, `Test Statement C`], () => {
    ...
    it(`calls findPromptStatesInStatement with the given onError`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), `Test On Error`, jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the first given statement`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), `Test Statement A`, jasmine.anything(), jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the next given statements`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), [`Test Statement B`, `Test Statement C`], jasmine.anything(), jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given prompt states`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Prompt States`, jasmine.anything()))
    it(`calls findPromptStatesInStatement with the given labels`, () => expect(findPromptStatesInStatement).toHaveBeenCalledWith(jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), jasmine.anything(), `Test Labels`))
    it(`returns the result of findPromptStatesInStatement`, () => expect(result).toEqual(`Test Recursed States`))
  })
